...
export async function registerAppointmentController(
  ...
  const { appointmentDateTime, observation, doctorName, patient, specialtyId } =
    registerAppointmentBodySchema.parse(req.body);
  ...
  try {
    ...
    await emailService.sendEmail({
      ...
      html: `
                ...
                <p><strong>Médico:</strong> ${doctorName} - ${specialtyId}</p>
                <br>
