...
describe('Update Appointment Status Use Case', () => {
    beforeEach(() => {
        ...
        sut = new RegisterAppointmentUseCase(appointmentsRepository, doctorsRepository, patientsRepository)
    ...
    it('Should be able to update appointment status', async () => {
        ...
        const updatedAppointment = await appointmentsRepository.findById(appointment.id)
